                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <%
                                        ...
                                        boolean isOperationExecuted = Boolean.parseBoolean(request.getParameter("isOperationExecuted")) ;
                                        if(msg != null){
                                    ...
                                    <table class="table table-nowrap datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img width="150" height="100" src="assets/img/category/<%= dto.getImage() %>" alt="alt"/></td>
                                                
                                                <td><%= dto.getCreated_at() %></td>
                                                <td>
                                                    <a href="updateCategory.jsp?id=<%= dto.getId() %>"><i class="fa fa-pencil text text-success"></i></a>
