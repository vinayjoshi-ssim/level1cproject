...
if(ServletFileUpload.isMultipartContent(request)) {
    ...
    boolean isOperationExecuted = dao.updateCategory(id, name, description, fileName);
    if(isOperationExecuted)
        response.sendRedirect("ServiceCategory.jsp?isOperationExecuted="+isOperationExecuted+"&msg=Category Updated Successfully");
    else
